...
FROM pizza_types JOIN pizzas ON pizza_types.pizza_type_id = pizzas.pizza_type_id ORDER BY pizzas.price DESC LIMIT 1;
...
-- Group the orders by date and calculate the average number of pizzas orderedm per day.
